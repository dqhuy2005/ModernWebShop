...
class UpdateUserRequest extends FormRequest
{
    ...
    public function rules(): array
    {
        ...
        return [
            ...
            // Email: required, valid format, unique (except current user), gmail standard
            'email' => [
                'required',
                'string',
                'email:rfc,dns', // RFC standard + DNS check
                'max:255',
            ...
            // Password: optional when updating, min 6 chars if provided
            'password' => [
                'nullable',
                'string',
                'min:6',
                'max:255',
                'confirmed',
                // Custom password rules (only apply if password is provided)
    ...
    public function messages(): array
    {
        return [
            ...
            // Language messages
            'language.in' => 'Ngôn ngữ phải là Tiếng Việt (vi) hoặc Tiếng Anh (en).',
        ];
    }
