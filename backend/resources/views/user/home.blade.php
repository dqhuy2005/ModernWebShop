...
@section('content')
    {{-- Component 1: Hero Banner - Hot Deal This Week --}}
    @include('components.user.hero-banner')

    {{-- Component 2: Featured Collections (3 Category Banners) --}}
    @include('components.user.featured-collections')

    {{-- Component 3: New Products with Tabs --}}
    @include('components.user.product-tabs', ['title' => 'NEW PRODUCTS'])

    {{-- Component 4: Top Selling Products (Horizontal Layout) --}}
    @include('components.user.top-selling')

    {{-- Component 5: Top Selling Products - Second Section --}}
    @include('components.user.product-tabs', ['title' => 'TOP SELLING'])
@endsection
